...
Like in the linux command line, there are multiple ways to add a second comman`CMD1 && CMD2  # run cmd1 and also cmd2  
...
> /var/www/html/cmdinjecter.txt  # try to redirect output to a file  
< /home/nastystuff.txt  # try to send input into a command`

 **PAYLOADS FOR FUZZING COMMAND INJECTION**  
via [_https://github.com/payloadbox/command-injection-payload-list_](https://github.com/payloadbox/command-injection-payload-list)
...
* 👉 [owasp.org/index.php/Testing\_for\_Command\_Injection\_\(OTG-INPVAL-013\)](https://www.owasp.org/index.php/Testing_for_Command_Injection_%28OTG-INPVAL-013%29)

**OWASP Command Injection**

* 👉 [owasp.org/index.php/Command\_Injection](https://www.owasp.org/index.php/Command_Injection)
...
* 👉 [portswigger.net/kb/issues/00100100\_os-command-injection](https://portswigger.net/kb/issues/00100100_os-command-injection)
